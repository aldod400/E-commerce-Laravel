                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3">
                            ...
                            <a class="btn btn-outline-light py-2 px-4 mt-3" href="{{ route('products') }}">Shop Now</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            @foreach ($categories as $category)
                    <div class="col-lg-3">
                        <div class="cat-card">
                            <div class="left">
                                <img src="{{ asset('storage\images\category-image\\' . $category->picture ) }}" alt="" class="img-fluid" style="max-height: 75px">
                            </div>
                            <div class="right">
                                <div class="cat-data">
                                    <h2>{{ $category->name }}</h2>
                                    <p>{{ App\Models\Product::where('category_id',$category->id)->count() }} Products</p>
                                </div>
                            </div>
                        </div>
                    </div>
